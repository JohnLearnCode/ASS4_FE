    ...
    <div className="d-flex align-items-center justify-content-center min-vh-100 p-4 bg-body-tertiary">
      <div className="card shadow-lg border-0" style={{ maxWidth: 420, width: '100%' }}>
        <div className="card-body p-4">
          ...
          <h1 className="text-center fs-4 fw-semibold mb-1">Đăng nhập</h1>
          <p className="text-center text-muted small mb-4">Chào mừng bạn trở lại!</p>
          ...
          <div className="text-center mt-4 small text-muted">
            Chưa có tài khoản? <Link to="/register" className="text-decoration-none fw-medium">Đăng ký</Link>
          </div>
        </div>
      </div>
    </div>
